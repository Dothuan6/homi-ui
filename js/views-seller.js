...
const Seller = {
  ...
  C01: function() {
    ...
    if (tab === 'stats') {
      ...
      tabHtml = TPL.render('c-01-commissions', { w, cw, cmKind: this.state.cmKind });
    } else {
      tabHtml = TPL.render('c-01-tree', { countsText: counts.map((n, i) => 'F' + (i + 1) + ': ' + n).join(' · '), treeHtml: this.downlineTree(u) });
    }
    const html = TPL.render('c-01', {
      u, tab, tabHtml,
  ...
  renderStats: function() {
    ...
    el.innerHTML = TPL.render('c-01-stats-body', { st, conversion: RULES.formatPercent(st.conversion, 1), rangeLabel: r.label, chartHtml });
  },
  renderCmChart: function() {
    ...
    el.innerHTML = TPL.render('c-01-cmchart', { rangeLabel: r.label, chartHtml });
  },
  ...
  renderCommissions: function() {
    ...
    el.innerHTML = TPL.render('c-01-commissions-table', { rows, pg, count: list.length, total });
  },
  ...
  C02: function() {
    ...
    return App.sellerShell('C-02', html);
  },
  ...
  ledger: function(u) {
    ...
    return TPL.render('c-03-ledger', { rows });
  },
  ...
  requests: function(u) {
    ...
    return TPL.render('c-03-requests', { list });
  },
  ...
  wdRender: function() {
    ...
    panel.innerHTML = TPL.render('c-03-withdraw', {
      step, steps, u, w,
  ...
  profile: function() {
    ...
    const html = TPL.render('c-profile', {
      u, ref, w,
